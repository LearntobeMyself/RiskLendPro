...
@Service
public class AdminLoanOpsServiceImpl implements AdminLoanOpsService {

    private static final Logger log = LoggerFactory.getLogger(AdminLoanOpsServiceImpl.class);
