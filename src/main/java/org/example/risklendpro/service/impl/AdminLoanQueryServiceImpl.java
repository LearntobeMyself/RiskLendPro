...
import org.example.risklendpro.pojo.request.BatchLoanApproveRequest;
import org.example.risklendpro.pojo.request.LoanApproveRequest;
import org.example.risklendpro.service.AdminLoanQueryService;
...
import org.example.risklendpro.utils.AdminExportHelper;
    ...
    public Map<String, Object> batchApprove(BatchLoanApproveRequest request, Long adminId) {
        ...
        for (Long loanId : request.getLoanIds()) {
            try {
                ...
                adminService.approveLoan(approveRequest);
                Loan loan = loanMapper.selectById(loanId);
                if (loan != null) {
